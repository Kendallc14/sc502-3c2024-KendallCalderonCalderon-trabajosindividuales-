...
function login($username, $password){
    try{
        ...
        $user = $stmt -> fetch(PDO::FETCH_ASSOC);//Guardar los datos del usuario
        if($user){//validar si usuario tiene un valor
            if(password_verify($password, $user['password'])){//validar la contraseña
...
//Guardad el tipo de solicitud si es post, put,get, etc
